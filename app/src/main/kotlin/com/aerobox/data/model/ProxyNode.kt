...
data class ProxyNode(
    ...
    val grpcPermitWithoutStream: Boolean? = null,
    val transportServiceName: String? = null,
    val wsMaxEarlyData: Int? = null,
    val wsEarlyDataHeaderName: String? = null,
    val alpn: String? = null,
    val tlsDisableSni: Boolean? = null,
    val tlsMinVersion: String? = null,
    val tlsMaxVersion: String? = null,
    val tlsCipherSuites: String? = null,
    val tlsCurvePreferences: String? = null,
    val tlsCertificatePublicKeySha256: String? = null,
    val tlsClientCertificate: String? = null,
    val tlsClientCertificatePath: String? = null,
    val tlsClientKey: String? = null,
    val tlsClientKeyPath: String? = null,
    val tlsFragment: Boolean? = null,
    val tlsFragmentFallbackDelay: String? = null,
    val tlsRecordFragment: Boolean? = null,
    val tlsKernelTx: Boolean? = null,
    val tlsKernelRx: Boolean? = null,
    ...
    val naiveStreamReceiveWindow: String? = null,
    val naiveQuicSessionReceiveWindow: String? = null,
    // Shared TLS certificate / ECH fields.
    val tlsCertificate: String? = null,
    val tlsCertificatePath: String? = null,
    val echEnabled: Boolean? = null,
    val echConfig: String? = null,
    val echConfigPath: String? = null,
    val echQueryServerName: String? = null,
