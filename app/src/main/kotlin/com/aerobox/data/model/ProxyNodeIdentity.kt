...
fun ProxyNode.connectionFingerprint(includeName: Boolean = true): String {
    return buildList {
        ...
        add(grpcPermitWithoutStream?.toString().normalizedIdentityValue())
        ...
        add(tlsDisableSni?.toString().normalizedIdentityValue())
        add(tlsMinVersion.normalizedIdentityValue())
        add(tlsMaxVersion.normalizedIdentityValue())
        add(tlsCipherSuites.normalizedIdentityValue())
        add(tlsCurvePreferences.normalizedIdentityValue())
        add(tlsCertificatePublicKeySha256.normalizedIdentityValue())
        add(tlsClientCertificate.normalizedIdentityValue())
        add(tlsClientCertificatePath.normalizedIdentityValue())
        add(tlsClientKey.normalizedIdentityValue())
        add(tlsClientKeyPath.normalizedIdentityValue())
        add(tlsFragment?.toString().normalizedIdentityValue())
        add(tlsFragmentFallbackDelay.normalizedIdentityValue())
        add(tlsRecordFragment?.toString().normalizedIdentityValue())
        add(tlsKernelTx?.toString().normalizedIdentityValue())
        add(tlsKernelRx?.toString().normalizedIdentityValue())
        ...
        add(brutalDebug?.toString().normalizedIdentityValue())
        ...
        add(naiveStreamReceiveWindow.normalizedIdentityValue())
        add(naiveQuicSessionReceiveWindow.normalizedIdentityValue())
        add(tlsCertificate.normalizedIdentityValue())
        add(tlsCertificatePath.normalizedIdentityValue())
        add(echEnabled?.toString().normalizedIdentityValue())
        add(echConfig.normalizedIdentityValue())
        add(echConfigPath.normalizedIdentityValue())
        add(echQueryServerName.normalizedIdentityValue())
